def find_shortest_path(start_index, end_index, cols, allowed):
    ...
    def shortest_path(index, visited):
        ...
        # ensures the same index will not be visited twice to prevent infinite recursion
...
if __name__ == "__main__":
  ...
  flag = find_shortest_path(1, 385, 40, allowed)
  print(f"Flag: {flag}")
